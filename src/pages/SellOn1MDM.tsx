...
const SellOn1MDM = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      image: 'https://images.pexels.com/photos/7656741/pexels-photo-7656741.jpeg?auto=compress&cs=tinysrgb&w=800'
    }
  ];
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            Join Thousands of Successful Medical Equipment Suppliers Worldwide
          </motion.h2>
        </div>
      </section>
      ...
      <section className="relative py-32 bg-red-600 overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            Expand Your Business Reach to Every Corner of the Globe
          </motion.h2>
        </div>
      </section>
